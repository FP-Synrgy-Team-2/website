        ...
        {navbar.map((item, index) => {
          ...
          return (
            <Link
              to={item.link}
              key={index}
              className={`sidebar-item flex items-center gap-5 rounded-md p-3 ${isActive ? 'bg-primary-blue text-white' : 'hover:bg-primary-dark-blue hover:text-white'} ${item.className ? item.className : ''}`}
