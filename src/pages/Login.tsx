...
function Login() {
    ...
    const defaultCssClass = 'w-full h-[55px] px-10 border border-black border-opacity-40 rounded-[5px] placeholder:text-lg-body placeholder:text-black placeholder:text-opacity-40';
    const errorCssClass = 'w-full h-[55px] px-10 border border-danger rounded-[5px] text-danger placeholder:text-lg-body placeholder:text-black placeholder:text-opacity-40;'
        ...
        <>
            {
                !isLoggedIn ? (
                    <div className="relative flex justify-between w-full h-screen">
                        <NavbarLogo className="absolute top-[50px] left-[68px]
                        ...
                        ">
                            <div className="
                                ...
                                w-[348px]
                            ">
                                <h1 aria-label="Masuk ke akun anda" className="text-[36px] font-bold">
                                    Masuk ke akun anda
                                </h1>
                                <span aria-label="Nikmati kemudahan mengelola keuangan Anda kapan saja" className="text-lg-body text-black text-opacity-40">
                                    Nikmati kemudahan mengelola keuangan Anda kapan saja
                                </span>
                            </div>
                            <div className="flex flex-col gap-y-5">
                                <div className="flex flex-col gap-y-2.5">
                                    <label aria-label="Username" htmlFor="username" className="text-xl-body">
                                        Username
                                    </label>
                                    <div className="relative">
                                        <input type="text" value={username} onChange={e => {setUsername(e.target.value); setLogInIsError(false)}} id="username" placeholder="Masukkan username anda" aria-label="text inputfield username" className={inputCssClass} />
                                ...
                                <div className="flex flex-col gap-y-2.5">
                                    <label htmlFor="password" aria-label="Password" className="text-xl-body">
                                        Password
                                    </label>
                                    <div aria-label="text inputfield password" className="relative">
                                        <input type={inputType} value={password} onChange={e => {setPassword(e.target.value); setLogInIsError(false)}} id="password"  placeholder="Masukkan password anda" className={inputCssClass} />
                                        <div className="absolute top-0 left-2.5 flex items-center h-[55px]">
                                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div aria-label="banner login" className="w-auto h-full">
                            <img src="images/login/login_image.webp" alt="" className="w-full h-full" />
                        </div>
                        <img src="images/login/blue_object_blc.webp" alt="" className="absolute bottom-0 left-0" />
                    </div>
                ) : (
