...
//   const { isAuthenticated, login, authResErrors } = useAuth();
...
//   useEffect(() => {
//     if (authResErrors) setInputCssClass(errorCssClass);
...
//     e.preventDefault();
//     login({ username, password }, '/dashboard', '/login');
...
//                     </svg>
//                   </div>
//                   <LoginErrSpan field="username" isShown={!!authResErrors} />
//                 </div>
//               </div>
//               <div className="flex flex-col gap-y-2.5">
//                 <label
...
//                     </button>
//                   </div>
//                   <LoginErrSpan field="password" isShown={!!authResErrors} />
//                 </div>
//               </div>
//             </div>
//             <button
