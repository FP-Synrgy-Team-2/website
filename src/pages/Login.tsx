                            ...
                            <div className="flex flex-col gap-y-5">
                                <div className="flex flex-col gap-y-2.5">
                                    ...
                                    <div className="relative">
                                        <input type="text" value={username} onChange={e => {setUsername(e.target.value)}} id="username" placeholder="Masukkan username anda" aria-label="text inputfield username" className="
                                            w-full h-[55px]
                                            px-10
                                ...
                                <div className="flex flex-col gap-y-2.5">
                                    ...
                                    <div aria-label="text inputfield password" className="relative">
                                        <input type={inputType} value={password} onChange={e => {setPassword(e.target.value)}} id="password"  placeholder="Masukkan password anda" className="
                                            w-full h-[55px]
                                            px-10
                                            border border-black border-opacity-40
                                            rounded-[5px]
