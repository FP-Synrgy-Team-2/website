            ...
            ">
                ...
                <div className="flex flex-col gap-y-5">
                    ...
                    <div className="flex flex-col gap-y-2.5">
                        ...
                        <div className="relative">
                            <input type={inputType} id="password"  placeholder="Masukkan password anda" className="
                                w-full h-[55px]
                                px-10
                                border border-black border-opacity-40
                                rounded-[5px]
                            ...
                            <div className="absolute top-0 right-2.5 flex items-center h-[55px]">
                                <button type="button" onClick={toggleShowPswd}>
