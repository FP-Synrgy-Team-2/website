...
function Transfer() {
  ...
  return (
    <section className="w-1/2 md:mx-[5%] md:w-auto">
      <Breadcrumbs
        breadcrumbs={[
          {
            label:
      ...
      <Link to={'/transfer/new'} aria-label="tombol transfer rekening baru">
        <ButtonPrimary className="flex h-[4rem] w-[30.75rem] items-center gap-[0.375rem] rounded-xl border-[0.5px] border-grey bg-primary-blue px-4 py-3 text-neutral-01 md:w-full">
          <img
